...
const Footer = () => {
  return (
    <footer>
      <div className="bg-blue py-5 shadow-footer">
        <div className="container flex flex-wrap md:flex-nowrap items-center justify-between gap-8">

          {/* footer left */}
          <div className="space-y-2">
            <h2>Elektron soliq xizmatlari</h2>
            <p className="text-[#628EA6] text-xs">Soliq organlarining elektron davlat xizmatlari portali</p>

            <ul>

              <li><a className="text-[#a8a8a8] text-sm font-normal" href="#">© 2015 - 2024 Soliq qo'mitasi.</a></li>
          ...
          <div className="space-y-5">
            ...
            <p className="text-[#628AE6]  text-sm font-normal"><i class="bi bi-telegram mr-1 text-base cursor-pointer"></i>Telegram:
              <a className="text-base font-normal text-white ml-1" href="#">@soliz_uz</a></p>
          </div>
